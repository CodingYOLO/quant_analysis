...
CHAINS: list[dict] = [
    ...
    {"chain": "💊 医药生物", "logic": "海外药企临床/销售数据 → 全球创新药定价与License-out预期 → "
              "A股创新药·CRO·减肥药链。传导偏'叙事同步'而非订单直连(除CXO确有海外订单)。"
              "⭐20260805实测反直觉：**诺和诺德(NVO)的传导远强于礼来(LLY)**"
              "(NVO→减肥药+21.3pct/创新药+23.1pct vs LLY→减肥药+7.1pct/创新药-0.3pct)——"
              "A股减肥药链多为司美格鲁肽仿制与多肽CDMO·跟的是NVO叙事；默沙东→创新药甚至为负"
              "(-6.6pct)。市值第一≠传导第一，看超额别看名气。",
     "items": [
         {"sym": "LLY", "cn": "礼来", "concepts": ["减肥药", "创新药"],
          "note": "全球药企市值第一·GLP-1(替尔泊肽)龙头·减肥药赛道总定价锚。"
                  "⚠️实测对A股传导弱于诺和诺德(A股映射标的多与司美相关)",
          "stocks": "华东医药·信达生物(港)·常山药业·博瑞医药·翰宇药业"},
         {"sym": "NVO", "cn": "诺和诺德", "concepts": ["减肥药", "创新药"],
          "note": "司美格鲁肽原研·GLP-1双雄之一·⭐**实测A股医药链传导最强的海外标的**"
                  "(超额+21~23pct)·其销售指引与专利到期节奏直接影响国产替代叙事",
          "stocks": "华东医药·翰宇药业·诺泰生物·圣诺生物(多肽CDMO)"},
         {"sym": "PFE", "cn": "辉瑞", "concepts": ["创新药", "生物疫苗"],
          "note": "大药企BD/并购风向·License-in/out活跃度影响A股创新药出海预期",
          "stocks": "恒瑞医药·百济神州·复星医药"},
         {"sym": "MRK", "cn": "默沙东", "concepts": ["创新药", "CRO概念"],
          "note": "K药专利悬崖→BD需求旺盛·是A股创新药License-out的主要买家之一",
          "stocks": "恒瑞医药·科伦博泰(港)·药明康德·凯莱英"},
         {"sym": "ISRG", "cn": "直觉外科", "concepts": ["医疗器械概念", "智能医疗"],
          "note": "达芬奇手术机器人垄断·全球医疗器械景气与国产替代对标",
          "stocks": "微创机器人(港)·迈瑞医疗·联影医疗·天智航"},
     ]},
    {"chain": "⛏ 资源(海外定价)", "logic": "海外矿业股是全球定价商品的**权益端**镜像——与领先指标页的"
              "商品期货互为印证：商品涨+矿业股涨=真景气；商品涨但矿业股不动=市场不信持续性。",
     "items": [
         {"sym": "FCX", "cn": "自由港", "concepts": ["金属铜", "PET铜箔"],
          "note": "全球最大上市铜矿商·铜价景气的权益端代表",
          "stocks": "紫金矿业·洛阳钼业·西部矿业·铜陵有色"},
         {"sym": "NEM", "cn": "纽蒙特", "concepts": ["黄金概念"],
          "note": "全球最大金矿商·金价与金矿股弹性的海外锚",
          "stocks": "山东黄金·中金黄金·赤峰黄金·紫金矿业"},
     ]},
    {"chain": "🏗 工业/农机", "logic": "海外工业股主要反映**美国本土**基建与农业景气。"
              "20260805实测：条件超额为正(CAT+7.8pct/DE+8.1pct)但**相关系数极低**(0.03~0.13)"
              "——属'偶尔共振'非稳定跟随，且A股'农机'概念标的少、样本偏噪音，仅作参照别当主线。",
     "items": [
         {"sym": "CAT", "cn": "卡特彼勒", "concepts": ["农机"],
          "note": "全球工程机械龙头·⚠️A股工程机械无对应同花顺概念(用农机近似·映射不精确)",
          "stocks": "三一重工·徐工机械·中联重科(⚠️仅行业参照·非概念直连)"},
         {"sym": "DE", "cn": "迪尔", "concepts": ["农机"],
          "note": "农机+精准农业龙头·对标A股农机自动化",
          "stocks": "一拖股份·星光农机·吉峰科技"},
     ]},
