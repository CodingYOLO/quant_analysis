...
_CHAINS: list[dict] = [
    ...
    {"name": "AI算力·芯片", "layers": [
        {"layer": "上游·设备 / 材料 / EDA", "kind": "material", "nodes": [
            {"name": "半导体设备", "leaders": [("北方华创", "002371"), ("中微公司", "688012"), ("拓荆科技", "688072")]},
            {"name": "半导体材料", "leaders": [("沪硅产业", "688126"), ("鼎龙股份", "300054"), ("安集科技", "688019")]},
            {"name": "EDA / IP", "leaders": [("华大九天", "301269"), ("概伦电子", "688206")]},
        ]},
        {"layer": "中游·设计 / 制造 / 封装", "kind": "mfg", "nodes": [
            {"name": "AI芯片/GPU", "leaders": [("寒武纪", "688256"), ("海光信息", "688041"), ("景嘉微", "300474")]},
            {"name": "晶圆代工", "leaders": [("中芯国际", "688981"), ("华虹宏力", "688347")]},
            {"name": "先进封装(CoWoS)", "leaders": [("通富微电", "002156"), ("长电科技", "600584"), ("甬矽电子", "688362"), ("华天科技", "002185")]},
        ]},
        {"layer": "下游·存储 / 模拟 / 功率", "kind": "app", "nodes": [
            {"name": "存储 / HBM", "leaders": [("兆易创新", "603986"), ("香农芯创", "300475"), ("江波龙", "301308"), ("德明利", "001309")]},
            {"name": "模拟 / 接口芯片", "leaders": [("圣邦股份", "300661"), ("纳芯微", "688052")]},
    ...
    {"name": "AI算力·光/PCB/连接", "layers": [
        {"layer": "上游·光芯片 / 覆铜板", "kind": "material", "nodes": [
            ...
            {"name": "光纤预制棒", "leaders": [("长飞光纤", "601869"), ("亨通光电", "600487")]},
        ]},
        ...
        {"layer": "下游·连接 / 交换", "kind": "app", "nodes": [
            {"name": "高速连接器", "leaders": [("华丰科技", "688629"), ("鼎通科技", "688668"), ("意华股份", "002897")]},
            {"name": "铜缆 / 线材", "leaders": [("沃尔核材", "002130"), ("精达股份", "600577")]},
    ...
    {"name": "具身智能·机器人", "layers": [
        {"layer": "上游·核心零部件", "kind": "mfg", "nodes": [
            ...
            {"name": "丝杠 / 执行器", "leaders": [("拓普集团", "601689"), ("北特科技", "603009")]},
